...
const WrapperIcon = ({ children }) => {
  return (
    <div className={styles.image_container}>
      <svg
        className={`${styles.background} ${styles.background_position_first}`}
        width="68"
        height="66"
        viewBox="0 0 68 66"
        fill="none"
      ...
      <svg
        className={`${styles.background} ${styles.background_position_second}`}
        width="107"
        height="100"
        viewBox="0 0 107 100"
        fill="none"
      ...
      <svg
        className={`${styles.background} ${styles.background_position_bottom}`}
        width="98"
        height="102"
        viewBox="0 0 98 102"
        fill="none"
